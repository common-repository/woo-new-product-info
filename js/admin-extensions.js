( function( $ ) {
	$( document ).ready( function() {
		...
		if ( ! woo_is_active() ) {
			var message = motpr355_woo_new_product_info_translations.woo_not_found;
			if ( woo_is_inactive() ) {
				message = motpr355_woo_new_product_info_translations.woo_inactive;
			}
			$( document ).on( 'click', '#motpr355_woo_new_product_info', function( e ) {
				e.preventDefault();
				alert( message );
			} );
		}
